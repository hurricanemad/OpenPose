                                         ...
                                         const double scaleInputToOutput)
    {
        try
        {
                ...
                if (!faceRectangles.empty())
                {
                    ...
                    {
						std::cout << "forwardPass 1" << std::endl;
                        ...
                        if (minFaceSize > 40)
                        {
			    			...
			    			std::cout << "forwardPass 2" << std::endl;
							...
							std::cout << "forwardPass 2.1" << std::endl;
                            cv::Mat faceImage;
							...
							std::cout << "forwardPass 2.2" << std::endl;
                            // cv::Mat -> float*
							...
							std::cout << "forwardPass 2.3" << std::endl;
                            // 1. Caffe deep network
                            upImpl->spNetCaffe->forwardPass(mFaceImageCrop);
							std::cout << "forwardPass 3" << std::endl;
                            // Reshape blobs
                            ...
                            // 3. Get peaks by Non-Maximum Suppression
                                ...
                                upImpl->spMaximumCaffe->Forward_cpu({upImpl->spHeatMapsBlob.get()},
                                                                    {upImpl->spPeaksBlob.get()});
                            #endif
							std::cout << "forwardPass 4" << std::endl;
